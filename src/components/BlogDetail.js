...
const BlogDetail = () => {
 ...
 {inputs && 
      ...
      <form onSubmit={handleSubmit}>
        <Box border={3} borderColor = "linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(40,24,59,1) 0%, rgba(2,0,36,1) 0%, rgba(139,35,118,1) 32%, rgba(229,27,194,1) 75%, rgba(35,28,31,1) 100%)" 
